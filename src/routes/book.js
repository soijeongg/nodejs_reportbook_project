...
import { postbookcontroller,getbookcontroller,updatebookcontoller, deletebookContoller } from "../controller/bookcontroller.js"
...
router.delete("/:bookId", authMiddleware, deletebookContoller)
